...
class ModelArguments:
    ...
    use_ps_dist_loss: bool = field(
        default=False,
        metadata={
            "help": ""
        }
    )
    ps_dist_loss_weight: float = field(
        default=0.2,
        metadata={
            "help": ""
        }
    )
    z1_z4_tau2: float = field(
        default=0.05,
        metadata={
            "help": ""
        },
    )
    ps_dist_distillation_loss: str = field(
        default=None
    )
    min_sim: float = field(
        default=0.6,
...
class DataTrainingArguments:
    ...
    def __post_init__(self):
        ...
        self.alternative_names_for_fixing = self.alternative_names_for_fixing.split(",")
    ...
    alternative_names_for_fixing: Optional[str] = field(
        default="neg_soft"
    )
...
def main():
    ...
    training_args.z1_z4_tau2 = model_args.z1_z4_tau2
