...
from models_scd.modeling_bert_4_24_0 import BertPreTrainedModel, BertModel, BertLMPredictionHead
from models_scd.modeling_roberta_4_24_0 import RobertaPreTrainedModel, RobertaModel, RobertaLMHead
...
def cl_forward(cls,
    ...
    first_teacher_z1_z4_sim_pred=None,
    second_teacher_z1_z4_sim_pred=None,
    distances1=None,
    distances2=None,
    distances3=None,
    distances4=None,
    ...
    if encoder.training and cls.model_args.num_columns:
    ...
    pooler_output = transform_view(pooler_output, num_sent)
...
# spearmanr
        ...
        if sent_emb:
            ...
            return cl_forward(self, self.bert,
                ...
                first_teacher_z1_z4_sim_pred=first_teacher_z1_z4_sim_pred,
                second_teacher_z1_z4_sim_pred=second_teacher_z1_z4_sim_pred,
                # spearmanr
