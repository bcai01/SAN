            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                with torch.no_grad():
                    ...
                    if teacher is not None: 
                        ...
                        if num_sent >= 3 :
                            teacher_z1_z3_sim_pred = cos(z1T.unsqueeze(1), z3T.unsqueeze(0)) / self.args.z1_z3_tau2
                        ...
                        if num_sent >= 3:
                            first_teacher_z1_z3_sim = cos(first_teacher_z1.unsqueeze(1), first_teacher_z3.unsqueeze(0)) / self.args.z1_z3_tau2
                            second_teacher_z1_z3_sim = cos(second_teacher_z1.unsqueeze(1), second_teacher_z3.unsqueeze(0)) / self.args.z1_z3_tau2
                            teacher_z1_z3_sim_pred = (self.args.alpha_ * first_teacher_z1_z3_sim) + ((1.0 - self.args.alpha_) * second_teacher_z1_z3_sim)
                    inputs["teacher_top1_sim_pred"] = teacher_top1_sim_pred
                    if num_sent >= 3:
                        inputs["teacher_z1_z3_sim_pred"] = teacher_z1_z3_sim_pred
